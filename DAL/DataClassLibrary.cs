...
namespace DAL
{
    ...
    public class ClsDataLayer
    {
        ...
        //public void InsertStateData(string StateName)
        //{        
        //    con.Close();
        //    con.Open();
        //    cmd = new SqlCommand("StateMasterInsert", con);
        //    cmd.CommandType = CommandType.StoredProcedure;           
        ...
        //    con.Close();
        //    con.Open();
        //    cmd = new SqlCommand("StateMasterUpdate", con);
        //    cmd.CommandType = CommandType.StoredProcedure;
        //    cmd.Parameters.Add("@STATENAME", SqlDbType.VarChar).Value = StateName;
        ...
        //public void InsertCityData(string StateID, string CityName)
        //{
        //    con.Close();
        //    con.Open();
        //    cmd = new SqlCommand("CityMasterInsert", con);
        //    cmd.CommandType = CommandType.StoredProcedure;
        //    cmd.Parameters.Add("@STATEID", SqlDbType.VarChar).Value = StateID;
        ...
        public void CompanyMasterInsertandUpdate(string TypeId, string COMPANYCODE, string COMPANYNAME, string SECTOR, string ADDRESS1, string ADDRESS2,
                    string ADDRESS3, string ADDRESS4, string EMAIL, string WEB, string OFFICENO1, string OFFICENO2, string MOBILENO, string FAXNO, string GSTNO,
                    string CSTNO, string ECCNO, string CODENO, string ESI, string PF, string PINCODE, string DATE, string CREATEBY, string CREATEDATE)
        {
            con.Close();
            con.Open();
            cmd = new SqlCommand(ServiceAction.CompanyMasterInsertandUpdate, con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.Add(AdminData.TYPEID, SqlDbType.Int).Value = TypeId;
            cmd.Parameters.Add(AdminData.COMPANYCODE, SqlDbType.VarChar).Value = COMPANYCODE;
            cmd.Parameters.Add(AdminData.COMPANYNAME, SqlDbType.VarChar).Value = COMPANYNAME;
            cmd.Parameters.Add(AdminData.SECTOR, SqlDbType.VarChar).Value = SECTOR;
            cmd.Parameters.Add(AdminData.ADDRESS1, SqlDbType.VarChar).Value = ADDRESS1;
            cmd.Parameters.Add(AdminData.ADDRESS2, SqlDbType.VarChar).Value = ADDRESS2;
            cmd.Parameters.Add(AdminData.ADDRESS3, SqlDbType.VarChar).Value = ADDRESS3;
            cmd.Parameters.Add(AdminData.ADDRESS4, SqlDbType.VarChar).Value = ADDRESS4;
            cmd.Parameters.Add(AdminData.EMAIL, SqlDbType.VarChar).Value = EMAIL;
            cmd.Parameters.Add(AdminData.WEB, SqlDbType.VarChar).Value = WEB;
            cmd.Parameters.Add(AdminData.OFFICENO1, SqlDbType.VarChar).Value = OFFICENO1;
            cmd.Parameters.Add(AdminData.OFFICENO2, SqlDbType.VarChar).Value = OFFICENO2;
            cmd.Parameters.Add(AdminData.MOBILENO, SqlDbType.VarChar).Value = MOBILENO;
            cmd.Parameters.Add(AdminData.FAXNO, SqlDbType.VarChar).Value = FAXNO;
            cmd.Parameters.Add(AdminData.GSTNO, SqlDbType.VarChar).Value = GSTNO;
            cmd.Parameters.Add(AdminData.CSTNO, SqlDbType.VarChar).Value = CSTNO;
            cmd.Parameters.Add(AdminData.ECCNO, SqlDbType.VarChar).Value = ECCNO;
            cmd.Parameters.Add(AdminData.CODENO, SqlDbType.VarChar).Value = CODENO;
            cmd.Parameters.Add(AdminData.ESI, SqlDbType.VarChar).Value = ESI;
            cmd.Parameters.Add(AdminData.PF, SqlDbType.VarChar).Value = PF;
            cmd.Parameters.Add(AdminData.PINCODE, SqlDbType.VarChar).Value = PINCODE;
            cmd.Parameters.Add(AdminData.DATE, SqlDbType.VarChar).Value = DATE;
            cmd.Parameters.Add(AdminData.CREATEBY, SqlDbType.VarChar).Value = CREATEBY;
            cmd.Parameters.Add(AdminData.CREATEDATE, SqlDbType.VarChar).Value = CREATEDATE;
        ...
        public void ClientMasterInsertandUpdate(string TypeId, string CLIENTCODE, string CLIENTNAME, string DIVISION, string CREATEBY, string CREATEDATE)
        {
            con.Close();
            con.Open();
            cmd = new SqlCommand(ServiceAction.ClientMasterInsertandUpdate, con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.Add(AdminData.TYPEID, SqlDbType.Int).Value = TypeId;
            cmd.Parameters.Add(AdminData.CLIENTCODE, SqlDbType.VarChar).Value = CLIENTCODE;
            cmd.Parameters.Add(AdminData.CLIENTNAME, SqlDbType.VarChar).Value = CLIENTNAME;
            cmd.Parameters.Add(AdminData.DIVISION, SqlDbType.VarChar).Value = DIVISION;
            cmd.Parameters.Add(AdminData.CREATEBY, SqlDbType.VarChar).Value = CREATEBY;
            cmd.Parameters.Add(AdminData.CREATEDATE, SqlDbType.VarChar).Value = CREATEDATE;
            int i = cmd.ExecuteNonQuery();
            if (i > 0)
        ...
        //------------- LCM Clinet Detail Master---        

        public void LCMClientDetailInsertandUpdate(string TypeId, string CLIENTID, string COMPANYID, string DIVISION, string SECTOR, string ADDRESS1, string TOWN, string STATEID,
                    string CITYID, string ENDATE, string PANNO, string GSTNO, string REGNO, string EPFNO, string ESINO, string PHONENO, string MOBILENO, string HRNO, string ACCNO, string EMAILID, string WEBSITE,
                    string FROMDATE, string TODATE, string CREATEBY, string CREATEDATE)
        {
            con.Close();
            con.Open();
            cmd = new SqlCommand(ServiceAction.LCMClientDetailInsertandUpdate, con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.Add(AdminData.TYPEID, SqlDbType.Int).Value = TypeId;
            cmd.Parameters.Add(AdminData.CLIENTID, SqlDbType.VarChar).Value = CLIENTID;
            cmd.Parameters.Add(AdminData.COMPANYID, SqlDbType.VarChar).Value = COMPANYID;
            cmd.Parameters.Add(AdminData.DIVISION, SqlDbType.VarChar).Value = DIVISION;
            cmd.Parameters.Add(AdminData.SECTOR, SqlDbType.VarChar).Value = SECTOR;
            cmd.Parameters.Add(AdminData.ADDRESS1, SqlDbType.VarChar).Value = ADDRESS1;
            cmd.Parameters.Add(AdminData.TOWN, SqlDbType.VarChar).Value = TOWN;
            cmd.Parameters.Add(AdminData.STATEID, SqlDbType.VarChar).Value = STATEID;
            cmd.Parameters.Add(AdminData.CITYID, SqlDbType.VarChar).Value = CITYID;
            cmd.Parameters.Add(AdminData.ENDATE, SqlDbType.VarChar).Value = ENDATE;
            cmd.Parameters.Add(AdminData.PANNO, SqlDbType.VarChar).Value = PANNO;
            cmd.Parameters.Add(AdminData.GSTNO, SqlDbType.VarChar).Value = GSTNO;
            cmd.Parameters.Add(AdminData.REGNO, SqlDbType.VarChar).Value = REGNO;
            cmd.Parameters.Add(AdminData.EPFNO, SqlDbType.VarChar).Value = EPFNO;
            cmd.Parameters.Add(AdminData.ESINO, SqlDbType.VarChar).Value = ESINO;

            cmd.Parameters.Add(AdminData.PHONENO, SqlDbType.VarChar).Value = PHONENO;
            cmd.Parameters.Add(AdminData.MOBILENO, SqlDbType.VarChar).Value = MOBILENO;
            cmd.Parameters.Add(AdminData.HRNO, SqlDbType.VarChar).Value = HRNO;
            cmd.Parameters.Add(AdminData.ACCNO, SqlDbType.VarChar).Value = ACCNO;
            cmd.Parameters.Add(AdminData.EMAILID, SqlDbType.VarChar).Value = EMAILID;
            cmd.Parameters.Add(AdminData.WEBSITE, SqlDbType.VarChar).Value = WEBSITE;
            cmd.Parameters.Add(AdminData.FROMDATE, SqlDbType.VarChar).Value = FROMDATE;
            cmd.Parameters.Add(AdminData.TODATE, SqlDbType.VarChar).Value = TODATE;
            cmd.Parameters.Add(AdminData.CREATEBY, SqlDbType.VarChar).Value = CREATEBY;
            cmd.Parameters.Add(AdminData.CREATEDATE, SqlDbType.VarChar).Value = CREATEDATE;
        ...
        //------------- PEM Clinet Detail Master--- 

        public void PEMClientDetailInsertandUpdate(string TypeId, string ClntID, string CmpID, string PemDiv, string PemSec, string PemStr, string PemTown,
            string PemCity, string PemState, string PemEnDate, string PemPANNO,
       string PemGST, string PemCST, string PemECC, string PemCode, string PemPFNo, string PemEsiNo, string PemOff1, string PemMob, string PemHrNo, string PemAccNo, string PemEmail, string PemWeb, string PemFromdt, string PemTodt, string CREATEBY, string CREATEDATE)
        {
            con.Close();
            con.Open();
            cmd = new SqlCommand(ServiceAction.PEMClientDetailInsertandUpdate, con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.Add(AdminData.TYPEID, SqlDbType.NVarChar).Value = TypeId;
            cmd.Parameters.Add(AdminData.CLIENTID, SqlDbType.NVarChar).Value = ClntID;
            cmd.Parameters.Add(AdminData.COMPANYID, SqlDbType.NVarChar).Value = CmpID;
            cmd.Parameters.Add(AdminData.DIVISION, SqlDbType.NVarChar).Value = PemDiv;
            cmd.Parameters.Add(AdminData.SECTOR, SqlDbType.NVarChar).Value = PemSec;
            cmd.Parameters.Add(AdminData.ADDRESS, SqlDbType.NVarChar).Value = PemStr;
            cmd.Parameters.Add(AdminData.TOWN, SqlDbType.NVarChar).Value = PemTown;
            cmd.Parameters.Add(AdminData.STATEID, SqlDbType.NVarChar).Value = PemState;
            cmd.Parameters.Add(AdminData.CITYID, SqlDbType.NVarChar).Value = PemCity;
            cmd.Parameters.Add(AdminData.ENDATE, SqlDbType.DateTime).Value = Convert.ToDateTime(PemEnDate);
            cmd.Parameters.Add(AdminData.PANNO, SqlDbType.NVarChar).Value = PemPANNO;
            cmd.Parameters.Add(AdminData.GSTNO, SqlDbType.NVarChar).Value = PemGST;
            cmd.Parameters.Add(AdminData.CSTNO, SqlDbType.NVarChar).Value = PemCST;
            cmd.Parameters.Add(AdminData.ECCNO, SqlDbType.NVarChar).Value = PemECC;
            cmd.Parameters.Add(AdminData.CODENO, SqlDbType.NVarChar).Value = PemCode;
            cmd.Parameters.Add(AdminData.EPFNO, SqlDbType.NVarChar).Value = PemPFNo;
            cmd.Parameters.Add(AdminData.ESINO, SqlDbType.NVarChar).Value = PemEsiNo;
            cmd.Parameters.Add(AdminData.PHONENO, SqlDbType.NVarChar).Value = PemOff1;
            cmd.Parameters.Add(AdminData.MOBILENO, SqlDbType.NVarChar).Value = PemMob;
            cmd.Parameters.Add(AdminData.HRNO, SqlDbType.NVarChar).Value = PemHrNo;
            cmd.Parameters.Add(AdminData.ACCNO, SqlDbType.NVarChar).Value = PemAccNo;
            cmd.Parameters.Add(AdminData.EMAIL, SqlDbType.NVarChar).Value = PemEmail;
            cmd.Parameters.Add(AdminData.WEB, SqlDbType.NVarChar).Value = PemWeb;
            cmd.Parameters.Add(AdminData.FROMDATE, SqlDbType.DateTime).Value = Convert.ToDateTime(PemFromdt);
            cmd.Parameters.Add(AdminData.TODATE, SqlDbType.DateTime).Value = Convert.ToDateTime(PemTodt);
        ...
        //------------- CC Clinet Detail Master--- 

        public void CCClientDetailInsertandUpdate(string TYPEID, string ClntID, string CmpID, string LcmDiv, string LcmSec, string LcmStr, string LcmTown, string LcmCity, string LcmState,
                      string LcmEnDate, string LcmGST, string LcmOff1, string LcmMob, string LcmHrNo, string LcmAccNo, string LcmEmail, string LcmWeb, string LcmEpfNo,
                      string LcmEsiNo, string LcmRegNo, string LcmFromdt, string LcmTodt, string CREATEBY, string CREATEDATE)
        {
            con.Close();
            con.Open();
            cmd = new SqlCommand("CCClientDetailInsertandUpdate", con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.Add(AdminData.TYPEID, SqlDbType.NVarChar).Value = TYPEID;
            cmd.Parameters.Add(AdminData.CLIENTID, SqlDbType.NVarChar).Value = ClntID;
            cmd.Parameters.Add(AdminData.COMPANYID, SqlDbType.NVarChar).Value = CmpID;
            cmd.Parameters.Add(AdminData.DIVISION, SqlDbType.NVarChar).Value = LcmDiv;
            cmd.Parameters.Add(AdminData.SECTOR, SqlDbType.NVarChar).Value = LcmSec;
            cmd.Parameters.Add(AdminData.ADDRESS, SqlDbType.NVarChar).Value = LcmStr;
            cmd.Parameters.Add(AdminData.TOWN, SqlDbType.NVarChar).Value = LcmTown;
            cmd.Parameters.Add(AdminData.STATEID, SqlDbType.NVarChar).Value = LcmState;
            cmd.Parameters.Add(AdminData.CITYID, SqlDbType.NVarChar).Value = LcmCity;
            cmd.Parameters.Add(AdminData.ENDATE, SqlDbType.DateTime).Value = Convert.ToDateTime(LcmEnDate);
            cmd.Parameters.Add(AdminData.GSTNO, SqlDbType.NVarChar).Value = LcmGST;
            cmd.Parameters.Add(AdminData.PHONENO, SqlDbType.NVarChar).Value = LcmOff1;
            cmd.Parameters.Add(AdminData.MOBILENO, SqlDbType.NVarChar).Value = LcmMob;
            cmd.Parameters.Add(AdminData.HRNO, SqlDbType.NVarChar).Value = LcmHrNo;
            cmd.Parameters.Add(AdminData.ACCNO, SqlDbType.NVarChar).Value = LcmAccNo;
            cmd.Parameters.Add(AdminData.EMAIL, SqlDbType.NVarChar).Value = LcmEmail;
            cmd.Parameters.Add(AdminData.WEB, SqlDbType.NVarChar).Value = LcmWeb;

            cmd.Parameters.Add(AdminData.EPFNO, SqlDbType.NVarChar).Value = LcmEpfNo;
            cmd.Parameters.Add(AdminData.ESINO, SqlDbType.NVarChar).Value = LcmEsiNo;
            cmd.Parameters.Add(AdminData.REGNO, SqlDbType.NVarChar).Value = LcmRegNo;

            cmd.Parameters.Add(AdminData.FROMDATE, SqlDbType.DateTime).Value = Convert.ToDateTime(LcmFromdt);
            cmd.Parameters.Add(AdminData.TODATE, SqlDbType.DateTime).Value = Convert.ToDateTime(LcmTodt);
       ...
       // }
        ...
        public void DepartmentMasterInsertAndUpdate(string TYPEID, string DepartmentName, string ClientID, string DepartmentCode, string CreateBy, string CreateDate)
        {
            con.Close();
            con.Open();
            cmd = new SqlCommand(ServiceAction.DepartmentMasterInsertAndUpdate, con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.Add(AdminData.TYPEID, SqlDbType.Int).Value = TYPEID;
            cmd.Parameters.Add(AdminData.DEPARTMENTNAME, SqlDbType.VarChar).Value = DepartmentName;
            cmd.Parameters.Add(AdminData.CLIENTID, SqlDbType.Int).Value = ClientID;
            cmd.Parameters.Add(AdminData.DEPARTMENTCODE, SqlDbType.VarChar).Value = DepartmentCode;
            cmd.Parameters.Add(AdminData.CREATEBY, SqlDbType.VarChar).Value = CreateBy;
            cmd.Parameters.Add(AdminData.CREATEDATE, SqlDbType.VarChar).Value = CreateDate;
            int i = cmd.ExecuteNonQuery();
            if (i > 0)
        ...
        public void DesignationMasterInsertAndUpdate(string TypeId, string DesignationCode, string DesignationName, string ClientID, string CreateBy, string CreateDate)
        {
            con.Close();
            con.Open();
            cmd = new SqlCommand(ServiceAction.DesignationMasterInsertAndUpdate, con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.Add(AdminData.TYPEID, SqlDbType.Int).Value = TypeId;
            cmd.Parameters.Add(AdminData.DESIGNATIONCODE, SqlDbType.VarChar).Value = DesignationCode;
            cmd.Parameters.Add(AdminData.DESIGNATIONNAME, SqlDbType.VarChar).Value = DesignationName;
            cmd.Parameters.Add(AdminData.CLIENTID, SqlDbType.VarChar).Value = ClientID;
            cmd.Parameters.Add(AdminData.CREATEBY, SqlDbType.VarChar).Value = CreateBy;
            cmd.Parameters.Add(AdminData.CREATEDATE, SqlDbType.VarChar).Value = CreateDate;
            int i = cmd.ExecuteNonQuery();
        ...
        public void BankDetailInsertAndUpdate(string TypeId, string BankName, string BankCode, string Branch, string Account, string Address, string Phoneno, string EmialId, string Others, string CreateBy, string CreateDate)
        {
            con.Close();
            con.Open();
            cmd = new SqlCommand(ServiceAction.BankDetailInsertAndUpdate, con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.Add(AdminData.TYPEID, SqlDbType.Int).Value = TypeId;
            cmd.Parameters.Add(AdminData.BANKNAME, SqlDbType.VarChar).Value = BankName;
            cmd.Parameters.Add(AdminData.BANKCODE, SqlDbType.VarChar).Value = BankCode;
            cmd.Parameters.Add(AdminData.BRANCH, SqlDbType.VarChar).Value = Branch;
            cmd.Parameters.Add(AdminData.ACCOUNTNUMBER, SqlDbType.VarChar).Value = Account;
            cmd.Parameters.Add(AdminData.ADDRESS, SqlDbType.VarChar).Value = Address;
            cmd.Parameters.Add(AdminData.PHONENO, SqlDbType.VarChar).Value = Phoneno;
            cmd.Parameters.Add(AdminData.EMAILID, SqlDbType.VarChar).Value = EmialId;
            cmd.Parameters.Add(AdminData.OTHER, SqlDbType.VarChar).Value = Others;
            cmd.Parameters.Add(AdminData.CREATEBY, SqlDbType.VarChar).Value = CreateBy;
            cmd.Parameters.Add(AdminData.CREATEDATE, SqlDbType.VarChar).Value = CreateDate;
            int i = cmd.ExecuteNonQuery();
            if (i > 0)
        ...
        //------------- Salary Detail Master--- 

        public void SalaryDetailInsertandUpdate(string TypeId, string ClntId, string Division, string Grade, string Basic, string Hra, string DA, string Convy, string Washing, string Others,
            string Total, string Otamt, string Special, string Bonus, string PF, string ESI,
            string Graduity, string Leavewage, string OtHour, string OtHour2, string Otamt2, string OtHour3, string Otamt3, string CreateBy, string CreateDate)
        {

            con.Close();
            con.Open();
            cmd = new SqlCommand("SalaryDetailInsertandUpdate", con);
            cmd.CommandType = CommandType.StoredProcedure;

            cmd.Parameters.Add(AdminData.TYPEID, SqlDbType.Int).Value = TypeId;
            cmd.Parameters.Add(AdminData.CLIENTID, SqlDbType.Int).Value = ClntId;
            cmd.Parameters.Add(AdminData.DIVISION, SqlDbType.NVarChar).Value = Division;

            cmd.Parameters.Add(AdminData.GRADE, SqlDbType.NVarChar).Value = Grade;
            cmd.Parameters.Add(AdminData.BASIC, SqlDbType.Decimal).Value = Basic;
            cmd.Parameters.Add(AdminData.HRA, SqlDbType.Decimal).Value = Hra;
            cmd.Parameters.Add(AdminData.DA, SqlDbType.Decimal).Value = DA;
            cmd.Parameters.Add(AdminData.CONVEYANCE, SqlDbType.Decimal).Value = Convy;
            cmd.Parameters.Add(AdminData.WASHING, SqlDbType.Decimal).Value = Washing;
            cmd.Parameters.Add(AdminData.OTHER, SqlDbType.Decimal).Value = Others;
            cmd.Parameters.Add(AdminData.TOTAL, SqlDbType.Decimal).Value = Total;
            cmd.Parameters.Add(AdminData.SPECIAL, SqlDbType.Decimal).Value = Special;
            cmd.Parameters.Add(AdminData.BONUS, SqlDbType.Decimal).Value = Bonus;
            cmd.Parameters.Add(AdminData.PF, SqlDbType.Decimal).Value = PF;
            cmd.Parameters.Add(AdminData.ESI, SqlDbType.Decimal).Value = ESI;
            cmd.Parameters.Add(AdminData.GRADUITY, SqlDbType.Decimal).Value = Graduity;
            cmd.Parameters.Add(AdminData.LEAVEWAGE, SqlDbType.Decimal).Value = Leavewage;

            cmd.Parameters.Add(AdminData.OTHOUR, SqlDbType.Decimal).Value = OtHour;
            cmd.Parameters.Add(AdminData.OTAMOUNT, SqlDbType.Decimal).Value = Otamt;
            cmd.Parameters.Add(AdminData.OTHOUR2, SqlDbType.Decimal).Value = OtHour2;
            cmd.Parameters.Add(AdminData.OTAMOUNT2, SqlDbType.Decimal).Value = Otamt2;
            cmd.Parameters.Add(AdminData.OTHOUR3, SqlDbType.Decimal).Value = OtHour3;
            cmd.Parameters.Add(AdminData.OTAMOUNT3, SqlDbType.Decimal).Value = Otamt3;
     ...
     string Tot10, string Tot5, string Tot2, string Tot1)
        ...
        public DataTable SelectESIEstablishment(string ClntId, string EmpCode)
        {
            con.Close();
            con.Open();
    ...
    string AC0, string AC1, string AC2, string AC10, string AC21, string AC22, string EmpShar, string Total)
        ...
        public void UserSettingInsert(string USERNAME, string PASSWORD)
        {
            con.Close();
            con.Open();
            cmd = new SqlCommand("UserSettingInsert", con);
            cmd.CommandType = CommandType.StoredProcedure;

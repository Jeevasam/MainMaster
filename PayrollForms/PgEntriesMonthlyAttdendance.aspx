...
<%--                                <asp:Button ID="btnTemplet" runat="server" CssClass="btn btn-primary" Text="EmployeeView" Width="130" OnClick="btnTemplet_Click" />--%>
            ...
            <div class="row"><%--tableview-frontview--%>

                <div id="" class=" col-lg-12 col-xl-12 ">

                    <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover table-secondary" HeaderStyle-CssClass="GVFixedHeader" HeaderStyle-BackColor=" #a6a6a6" BorderColor="#999999" BorderStyle="Solid" BorderWidth="2px" AutoGenerateColumns="False" OnRowEditing="GridView1_RowEditing" OnRowDataBound="GridView1_RowDataBound" 
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Type">
                                ...
                                <FooterStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="freezed" Width="100px" />
                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="freezed" Width="100px" />
                                <ItemStyle Width="100px" />
                            </asp:TemplateField>

                            <asp:TemplateField HeaderText="EMPLOYEECODE">
                                <ItemTemplate>
                                    <asp:Label ID="lblEMPLOYEECODE" runat="server" CssClass="form-control form-control-sm txtnew text-uppercase" Width="100" Text='<%# Bind("EMPLOYEECODE") %>'></asp:Label>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="EMPLOYEE NAME">
                                <ItemTemplate>
                                    <asp:Label ID="lblAPPLICATIONAME" runat="server" CssClass="form-control form-control-sm txtnew text-uppercase" Width="150" Text='<%# Bind("APPLICATIONAME") %>'></asp:Label>
                                </ItemTemplate>
                                <FooterStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="freezed" />
                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="freezed" />
                                <ControlStyle Width="200px" BorderStyle="None" CssClass="freezed"></ControlStyle>
                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="freezed" />
                            </asp:TemplateField>
    ...
    <script type="text/javascript"> //ContentPlaceHolder1_DgCompany
        window.onload = function () {
            var gridViewScroll = new GridViewScroll({
                elementID: "ContentPlaceHolder1_GridView1",

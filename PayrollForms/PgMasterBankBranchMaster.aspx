...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="tab-content" id="pills-tabContent">
        ...
        <div class="tab-pane fade" id="pills-view" role="tabpanel" aria-labelledby="pills-view-tab">
            ...
            <div class="row"> <%--tableview-endview--%>

                <div id="" class=" col-lg-12 col-xl-12">
                    <asp:HiddenField ID="hidcurrenttab" Value="1" runat="server" />

                    <asp:GridView ID="DgBankDetail" runat="server" HeaderStyle-BackColor="#a6a6a6" BorderColor="#999999" BorderStyle="Solid" BorderWidth="2px" CssClass="table table-hover table-secondary" OnSelectedIndexChanged="DgBankDetail_SelectedIndexChanged" AutoGenerateColumns="False" Font-Size="10pt">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="IFSC CODE">
                                ...
                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="freezed"/>
                                <ControlStyle Height="25px" Width="100px"></ControlStyle>
                                <ItemStyle CssClass="freezed" />
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="ADDRESS">
                                ...
                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                <ControlStyle Height="25px" Width="470px"></ControlStyle>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="MOBILE NO">
                                ...
                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                <ControlStyle Height="25px" Width="130px"></ControlStyle>
                            </asp:TemplateField>

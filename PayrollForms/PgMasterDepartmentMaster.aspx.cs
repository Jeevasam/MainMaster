    ...
    protected void btnsave_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            if (TypeId.Text == "0")
            {
                ...
                if (Error == "0")
                {
                    objectBL.DepartmentMasterInsertAndUpdate(TypeId.Text, txtdepartmentname.Text, ddlclientname.SelectedValue, txtdepartmentcode.Text, "0", DateTime.Now.ToString());

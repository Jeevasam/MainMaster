    ...
    <div class="tab-content" id="pills-tabContent">
        <div class="tab-pane fade show active" id="pills-clientdetail" role="tabpanel" aria-labelledby="pills-clientdetail-tab">
                ...
                <div class="row col-lg-12 col-xl-12">
                    ...
                    <div id="DE-Deductionstxt" class=" col-lg-2 col-xl-2">
                        <asp:Label ID="lblnoofemp" runat="server" CssClass="label-conrol col-sm-12 lblnew" Text="No of Employees"></asp:Label>
                        <div class="form-group">
                            <div class=" col-lg-12 col-xl-12">
                                <asp:TextBox ID="txtnoofemp" CssClass="form-control form-control-sm txtnew text-uppercase" autocomplete="off" ReadOnly="true" Width="100" runat="server"></asp:TextBox>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div id="" class="col-lg-12 col-xl-12">
                    ...
                    <asp:GridView ID="DgDeduction" runat="server" OnSelectedIndexChanged="DgDeduction_SelectedIndexChanged" OnSelectedIndexChanging="DgDeduction_SelectedIndexChanging" EditIndex="2" OnRowEditing="DgDeduction_RowEditing"
                        BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="2px" CellSpacing="2" ForeColor="Black" HorizontalAlign="Center" CssClass="table table-hover table-secondary" HeaderStyle-BackColor="#a6a6a6" AutoGenerateColumns="False" OnRowCreated="DgDeduction_RowCreated" Font-Size="10pt">
                        <Columns>
        ...
        <div class="tab-pane fade" id="pills-view" role="tabpanel" aria-labelledby="pills-view-tab">
            ...
            <div class="row col-lg-12 col-xl-12">
                ...
                <asp:GridView ID="DgDeductionView" CssClass="table table-hover table-secondary" runat="server" BackColor="#CCCCCC"
                    BorderColor="#999999" BorderStyle="Solid" BorderWidth="2px" OnSelectedIndexChanged="DgDeductionView_SelectedIndexChanged"
    ...
    <script type="text/javascript"> //ContentPlaceHolder1_DgCompany
        window.onload = function () {
            var gridViewScroll = new GridViewScroll({
                elementID: "ContentPlaceHolder1_DgDeduction",

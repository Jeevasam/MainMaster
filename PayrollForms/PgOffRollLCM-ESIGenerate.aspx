                                ...
                                <asp:GridView ID="DgESIGenerate" runat="server" CssClass="table table-hover table-secondary"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="EMP.ID No">
                                            <ItemTemplate>
                                                <asp:Label ID="lblempidno" runat="server" Width="250" Text='<%# Bind("EMPLOYEECODE") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ControlStyle CssClass="freezed" />
                                            ...
                                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="freezed" />
                                             <ControlStyle Height="25px" Width="85px"></ControlStyle>

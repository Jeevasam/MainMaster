...
public partial class PayrollForms_PayrollReports_PgPayReport_Form_26 : System.Web.UI.Page
{
    ...
    {
        if (ddlType.SelectedValue == "Forms(26)Muster Roll Register")
        {
            ReportFor26Form();
        }
        else
    ...
    private void ReportForWage27Form()
    {
        ...
        if (ddlType.SelectedValue == "Forms(27)XXVII For Wages")
        {
        ...
        else if (ddlType.SelectedValue == "Forms(29)XXIX For Damages Loss or Fines")
        {
        ...
        else if (ddlType.SelectedValue == "Forms(23)XXIII Overtime Register")
        {
    ...
    {
        ds = new DataSet();
        ds = ObjectBA.SelectMonthlyPaySlip(Convert.ToDateTime(txtfromdate.Text).ToShortDateString(), Convert.ToDateTime(txttodate.Text).ToShortDateString(), ddlcompanyname.SelectedValue);
    }

    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" EnableViewState="true">
        <ContentTemplate>
            ...
            <div class="row col-lg-12 col-xl-12 ">
                <rsweb:ReportViewer ID="ReportViwerRegularBillWageStatement" runat="server" Width="1200px" Font-Names="Verdana" Font-Size="10pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" BackColor="#CCCCB3" BorderColor="#999999" BorderStyle="Groove" Visible="false">

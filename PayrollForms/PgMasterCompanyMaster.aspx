                ...
                <div class="tab-pane fade" id="pills-view" role="tabpanel">
                    ...
                    <div class="row">
                        ...
                        <div id="tableview-endview" class=" col-lg-12 col-xl-12">
                            ...
                            <asp:GridView ID="DgCompany" runat="server" CssClass="table table-hover table-secondary" HeaderStyle-BackColor=" #a6a6a6" BorderColor="#999999" BorderStyle="Solid" BorderWidth="2px"
...
<%--    <script type="text/javascript"> //ContentPlaceHolder1_DgCompany
        window.onload = function () {
            var gridViewScroll = new GridViewScroll({
                elementID: "ContentPlaceHolder1_DgCompany",

                            ...
                            <asp:GridView ID="DgGSTFront" runat="server" CssClass="table table-hover table-secondary"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Invoice No">
                                        ...
                                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="freezed"/>
                                        <ControlStyle Height="12px" Width="70px"></ControlStyle>
                                    ...
                                    <asp:TemplateField HeaderText="Invoice Date">
                                        ...
                                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="freezed" />
                                        <ControlStyle Height="12px" Width="110px" CssClass="freezed"></ControlStyle>
                                         <ItemStyle Wrap="False" CssClass="freezed"/>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Client Name">
                                        ...
                                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="freezed" />
                                        <ControlStyle Height="12px" Width="250px" CssClass="freezed"></ControlStyle>
                                         <ItemStyle Wrap="False" CssClass="freezed"/>
                                    </asp:TemplateField>

    ...
    protected void btnupdate_Click(object sender, EventArgs e)
    {
        ...
        {   
            if(TypeId.Text == "0")
            {
                ...
                if(check == "0")
                {
                    objectBL.CompanyMasterInsertandUpdate(TypeId.Text, txtcompanycode.Text, txtcompanyname.Text, txtsector.Text, txtnoandstreet.Text, txttownarea.Text, txtcityname.Text,
                        txtstate.Text, txtemailid.Text, txtwebsite.Text, txtofficeph1.Text, txtofficeph2.Text, txtmobileno.Text, txtfaxno.Text, txtgstno.Text, txtcstno.Text,
                        txteccno.Text, txtsacno.Text, txtesino.Text, txtpfno.Text, txtcitypin.Text, Convert.ToDateTime(txtenrolldate.Text).ToShortDateString(), "0", DateTime.Now.ToString());

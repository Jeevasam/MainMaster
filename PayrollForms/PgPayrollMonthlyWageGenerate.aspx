                ...
                <div class="row">
                    ...
                    <div id="tableview-endview" class="col-lg-12 col-xl-12">
                        ...
                        <asp:GridView ID="DgPayroll" runat="server" CssClass="table table-hover table-secondary"
                            ...
                            BorderWidth="2px" AutoGenerateColumns="False" Font-Size="10pt" ShowFooter="True">
                            <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="EMPLOYEE CODE" HeaderStyle-BackColor="#ff9999">
                                        ...
                                        <controlstyle height="12px" width="150px" CssClass="freezed"></controlstyle>
                                    </asp:TemplateField>
    ...
    <script type="text/javascript"> //ContentPlaceHolder1_DgCompany
        window.onload = function () {
            var gridViewScroll = new GridViewScroll({
                elementID: "ContentPlaceHolder1_DgPayroll",

                    ...
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                        ...
                        <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("APPLICATIONID") %>'></asp:TextBox>  
                                    ...
                                    <asp:TemplateField HeaderText="ET1">
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtET1" runat="server" CssClass="form-control" Text='<%# Bind("OT1") %>' Width="100"></asp:TextBox>
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="lblET1" runat="server" CssClass="form-control" Text='<%# Bind("OT1") %>' Height="30px" Font-Size="13px" Width="100"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="ET2">
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtET2" runat="server" CssClass="form-control" Text='<%# Bind("OT2") %>' Width="100"></asp:TextBox>
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="lblET2" runat="server" CssClass="form-control" Text='<%# Bind("OT2") %>' Height="30px" Font-Size="13px" Width="100"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="ET3">
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtET3" runat="server" CssClass="form-control" Text='<%# Bind("OT3") %>' Width="100"></asp:TextBox>
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="lblET3" runat="server" CssClass="form-control" Text='<%# Bind("OT3") %>' Height="30px" Font-Size="13px" Width="100"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

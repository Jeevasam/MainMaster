...
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="Server">
    ...
    <div class="tab-content" id="pills-tabContent">
        ...
        <div class="tab-pane fade active show" id="pills-companymaster" role="tabpanel" aria-labelledby="pills-companymaster-tab">
            ...
            <div class="row"> <%--tableview-front--%>
                <div id="" class="col-lg-12 col-xl-12">

                    <%--<asp:UpdatePanel ID="UpdatePanel2" runat="server">
                        <ContentTemplate>--%>

                            <asp:GridView ID="Dginvoiceview" runat="server" AutoGenerateColumns="false" CssClass="table table-hover table-secondary" HeaderStyle-BackColor=" #a6a6a6" BorderColor="#999999" 
                                BorderStyle="Solid" BorderWidth="2px" Font-Size="10pt" ShowFooter="True">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="EMPLOYEE CODE" HeaderStyle-BackColor="#ff9999">
                                        ...
                                        <ControlStyle Height="12px" Width="75px" CssClass="freezed"></ControlStyle>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="EMPLOYEE NAME" HeaderStyle-BackColor="#ff9999">
                                        ...
                                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="freezed" />
                                        <ControlStyle Height="12px" Width="200px" CssClass="freezed"></ControlStyle>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="DEPARTMENT NAME" HeaderStyle-BackColor="#ff9999">
                                        ...
                                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="freezed" />
                                        <ControlStyle Height="12px" Width="175px" CssClass="freezed"></ControlStyle>
                                    </asp:TemplateField>
                   ...
                   <%-- <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                        <ContentTemplate>--%>
                            ...
                            <div class="row col-md-12 col-xl-12" style="background-color:#f5f5ef;">
                                <table class="table table-sm border col-lg-6 col-xl-6">
                                    <thead>
                                        <tr>

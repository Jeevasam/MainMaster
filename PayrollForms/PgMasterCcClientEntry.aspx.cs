    ...
    protected void btnsave_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            if (TypeID.Text == "0")
            {
                ...
                if (check == "0")
                {
                    ObjectBL.CCClientDetailInsertandUpdate (TypeID.Text, ddlccclientname.SelectedValue, ddlcompanyname.SelectedValue, txtcompanyname.Text, txtsector.Text, txtprenoandstreet.Text, txtpretownarea.Text,
                    ...
                    txtaccountantnumber.Text, txtemailid.Text, txtwebsite.Text,txtpfno.Text,txtesino.Text,txteccno.Text, Convert.ToDateTime(txtcfdate.Text).ToShortDateString(), Convert.ToDateTime(txttodate.Text).ToShortDateString(), "0", DateTime.Now.ToString());

...
public partial class PayrollForms_PayrollReports_RegularBillWageStatement : System.Web.UI.Page
{
    ...
    protected void Dg_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "WageStatement")
        {
            ...
            string FilePath = Environment.GetFolderPath(Environment.SpecialFolder.UserProfile) + "\\Downloads/WageStatement.pdf";    // Direct Download Folder Access... 
        ...
        if (e.CommandName == "Invoice")
        {
            ...
            string FilePath = Environment.GetFolderPath(Environment.SpecialFolder.UserProfile) + "\\Downloads/InvoiceBill.pdf";  // Direct Download Folder Access... 
        ...
        if (e.CommandName == "Annexur")
        {
            ...
            string FilePath = Environment.GetFolderPath(Environment.SpecialFolder.UserProfile) + "\\Downloads/Annexur.pdf";  // Direct Download Folder Access... 

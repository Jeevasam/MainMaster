            ...
            <div class="row"> <%--tableview-frontview--%>
                ...
                <div id="" class="col-lg-12 col-xl-12">
                    ...
                    <asp:GridView ID="DgAllowances" runat="server" AutoGenerateColumns="False"
                        BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="2px" CellPadding="4" CellSpacing="2" ForeColor="Black"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Emloyee Code">
                                ...
                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="freezed" Height="55px"/>
    ...
    <script type="text/javascript"> //ContentPlaceHolder1_DgCompany
        window.onload = function () {
            var gridViewScroll = new GridViewScroll({
                elementID: "ContentPlaceHolder1_DgAllowances",

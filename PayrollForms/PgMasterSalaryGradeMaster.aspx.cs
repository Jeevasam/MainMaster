    ...
    protected void btnsave_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (TypeID.Text == "0")
            {
                ...
                if (ErrorTag == "0")
                {
                    ObjectBL.SalaryDetailInsertandUpdate(TypeID.Text, ddlclientname.SelectedValue, txtdivision.Text, txtsalarygradeid.Text, txtbasic.Text, txthra.Text, txtda.Text, txtconveyance.Text,
                    txtwashing.Text, txtother.Text,
                    txttotal.Text, txtOtAmount1.Text, txtspecial.Text, txtbonus.Text, txtpf.Text, txtesi.Text, 
                    txtgraduity.Text, txtleavewithwages.Text, txtOt1.Text,txtOt2.Text,txtOtAmount2.Text,txtOt3.Text,txtOtAmount3.Text, "0", DateTime.Now.ToString());

           ...
           <%-- <asp:UpdatePanel ID="UpdatePanel2" runat="server" EnableViewState="true">
                <ContentTemplate>--%>
                    ...
                    <asp:GridView ID="GDEmpViewandEdit" runat="server" CssClass="table table-hover table-secondary" HeaderStyle-BackColor=" #a6a6a6"
                        BorderColor="#999999" BorderStyle="Solid" BorderWidth="2px" OnPageIndexChanging="GDEmpViewandEdit_PageIndexChanging"
                        ...
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:Button ID="btn_Edit" runat="server" CssClass="btn btn-primary" Text="Edit" CommandName="Edit" Width="85" Style="font-size: smaller" />
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <asp:Button ID="btn_Update" runat="server" CssClass="btn btn-primary" Text="Update" CommandName="Update" Width="85" Style="font-size: smaller" />
                                    <asp:Button ID="btn_Cancel" runat="server" CssClass="btn btn-primary" Text="Cancel" CommandName="Cancel" Width="85" Visible="false" Style="font-size: smaller" />
                                </EditItemTemplate>
                                <HeaderStyle CssClass="freezed" />
                                <ItemStyle CssClass="freezed" />
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="EMPLOYEE CODE">
                                ...
                                <HeaderStyle CssClass="freezed"></HeaderStyle>
    ...
    <script type="text/javascript"> //ContentPlaceHolder1_DgCompany
        window.onload = function () {
            var gridViewScroll = new GridViewScroll({
                elementID: "ContentPlaceHolder1_GDEmpViewandEdit",

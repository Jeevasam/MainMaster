    ...
    <div class="tab-content" id="pills-tabContent">
        <div class="tab-pane fade show active" id="pills-departmentmaster" role="tabpanel" aria-labelledby="pills-departmentmaster-tab">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div id="" class="col-lg-5 col-xl-5">
                        ...
                        <div class="form-group row">
                            <asp:Label ID="lblTotalEPFcontributionAC1" runat="server" CssClass="label-conrol col-sm-6 lblnew" Style="font-size: smaller" AutoPostBack="True" Text="Total EPF Contribution A/C 1"></asp:Label>
                            <asp:Label ID="Label1" runat="server" CssClass="label-conrol  col-sm-3 " Style="font-size: smaller" Text="12 %"></asp:Label>
                            <asp:TextBox ID="txtTotalEPFcontributionAC1" CssClass="form-control form-control-sm text-uppercase txtnew col-sm-3" ReadOnly="true" runat="server" OnTextChanged="txtTotalEPFcontributionAC1_TextChanged"></asp:TextBox>
                        </div>

                        <div class="form-group row">
                            <asp:Label ID="lblTotalEPScontributionAC10" runat="server" CssClass="label-conrol col-sm-6 lblnew" Style="font-size: smaller" AutoPostBack="True" Text="Total EPS Contribution A/C 10"></asp:Label>
                            <asp:Label ID="Label3" runat="server" CssClass="label-conrol  col-sm-3 " Style="font-size: smaller" Text="8.33 %"></asp:Label>
                            <asp:TextBox ID="txtTotalEPScontributionAC10" CssClass="form-control form-control-sm text-uppercase txtnew col-sm-3" ReadOnly="true" runat="server" OnTextChanged="txtTotalEPScontributionAC10_TextChanged"></asp:TextBox>
                        </div>

                        <div class="form-group row">
                            <asp:Label ID="lblTotaldifferencebetweenEPFEPSAC1" runat="server" CssClass="label-conrol col-sm-6 lblnew" Style="font-size: smaller" AutoPostBack="True" Text="Total Difference Between EPF &EPS A/C 1"></asp:Label>
                            <asp:Label ID="Label4" runat="server" CssClass="label-conrol  col-sm-3 " Style="font-size: smaller" Text="3.67 %"></asp:Label>
                            <asp:TextBox ID="txtTotaldifferencebetweenEPFEPSAC1" CssClass="form-control form-control-sm text-uppercase txtnew col-sm-3" ReadOnly="true" runat="server" OnTextChanged="txtTotaldifferencebetweenEPFEPSAC1_TextChanged"></asp:TextBox>
                        </div>

                        <div class="form-group row">
                            <asp:Label ID="lblTotalEDLIcontributionERshareAC21" runat="server" CssClass="label-conrol col-sm-6 lblnew" Style="font-size: smaller" AutoPostBack="True" Text="Total EDLI Contribution (ER Share A/C) 21"></asp:Label>
                            <asp:Label ID="Label9" runat="server" CssClass="label-conrol  col-sm-3 " Style="font-size: smaller" Text="0.50 %"></asp:Label>
                            <asp:TextBox ID="txtTotalEDLIcontributionERshareAC21" CssClass="form-control form-control-sm text-uppercase txtnew col-sm-3" ReadOnly="true" runat="server" OnTextChanged="txtTotalEDLIcontributionERshareAC21_TextChanged"></asp:TextBox>
                        </div>

                        <div class="form-group row">
                            <asp:Label ID="lblTotalEPFchargesadministrationAC2" runat="server" CssClass="label-conrol col-sm-6 lblnew" Style="font-size: smaller" AutoPostBack="True" Text="Total Epf Charges (Administration) A/C 2"></asp:Label>
                            <asp:Label ID="Label5" runat="server" CssClass="label-conrol  col-sm-3 " Style="font-size: smaller" Text="0.50 %"></asp:Label>
                            <asp:TextBox ID="txtTotalEPFchargesadministrationAC2" CssClass="form-control form-control-sm text-uppercase txtnew col-sm-3" ReadOnly="true" runat="server" OnTextChanged="txtTotalEPFchargesadministrationAC2_TextChanged"></asp:TextBox>
                        </div>
                    ...
                    <div id="" class="col-lg-4 col-xl-4">
                        ...
                        <div class="form-group row">
                            <asp:Label ID="lblTotalEDLIchargesaministrationac22" runat="server" CssClass="label-conrol col-sm-6 lblnew" Style="font-size: smaller" AutoPostBack="True" Text="Total EDLI Charges (Aministration)A/C 22"></asp:Label>
                            <asp:Label ID="Label6" runat="server" CssClass="label-conrol  col-sm-3 " Style="font-size: smaller" Text="0.00 %"></asp:Label>
                            <asp:TextBox ID="txtTotalEDLIchargesaministrationac22" CssClass="form-control form-control-sm text-uppercase txtnew col-sm-3" ReadOnly="true" runat="server" OnTextChanged="txtTotalEDLIchargesaministrationac22_TextChanged"></asp:TextBox>
                        </div>

                        <div class="form-group row">
                            <asp:Label ID="lblTotalrefundofadvanceAC1" runat="server" CssClass="label-conrol col-sm-6 lblnew" Style="font-size: smaller" AutoPostBack="True" Text="Total Refund of Advance A/C 1"></asp:Label>
                            <asp:Label ID="Label11" runat="server" CssClass="label-conrol  col-sm-3 " Style="font-size: smaller" Text="0.00 %"></asp:Label>
                            <asp:TextBox ID="txtTotalrefundofadvanceAC1" CssClass="form-control form-control-sm text-uppercase txtnew col-sm-3" ReadOnly="true" runat="server"></asp:TextBox>
                        </div>

                        <div class="form-group row">
                            <asp:Label ID="lblAllTotal" runat="server" CssClass="label-conrol col-sm-4 lblnew" Style="font-size: smaller" AutoPostBack="True" Text="All Total"></asp:Label>
                            <asp:Label ID="Label10" runat="server" CssClass="label-conrol  col-sm-3 " Style="font-size: smaller" Text="25 %"></asp:Label>
                            <asp:TextBox ID="txtAllTotal" CssClass="form-control form-control-sm text-uppercase txtnew col-sm-5" ReadOnly="true" runat="server" OnTextChanged="txtAllTotal_TextChanged"></asp:TextBox>
                        </div>
                        <br />
                        <br />
                ...
                <div class="row">  <%--ableview-frontview--%>

                    <div id="" class="col-lg-12 col-xl-12">

                        <asp:GridView ID="DgPFGenerate" runat="server" CssClass="table table-hover table-secondary"
                            HeaderStyle-BackColor=" #a6a6a6" BorderColor="#999999" BorderStyle="Solid" BorderWidth="2px"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="SL.No">
                                    ...
                                    <FooterStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="freezed" />
                                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="freezed" />
                                    <ControlStyle Height="30px" Width="50px"></ControlStyle>
                                    <ItemStyle Wrap="False" CssClass="freezed" />
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Member ID">
                                    ...
                                    <FooterStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="freezed" />
                                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="freezed" />
                                    <ControlStyle Height="30px" Width="150px"></ControlStyle>
                                    <ItemStyle Wrap="False" CssClass="freezed" />
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Employee Code" Visible="false">
                                    ...
                                    <FooterStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="freezed" />
                                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="freezed" />
                                    <ControlStyle Height="30px" Width="100px"></ControlStyle>
                                    <ItemStyle Wrap="False" CssClass="freezed" />
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Employee Name">
                                    ...
                                    <FooterStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="freezed" />
                                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="freezed" />
                                    <ControlStyle Height="30px" Width="200px"></ControlStyle>
                                    <ItemStyle Wrap="False" CssClass="freezed" />
                                </asp:TemplateField>

                                <asp:TemplateField HeaderText="Working Unit / Company Name">
                                    <ItemTemplate>
                                        <asp:Label ID="lblcompanyname" runat="server" Width="200" Text='<%# Bind("CLIENTNAME") %>'></asp:Label>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Total EPF Contribution EE Share A/C 1">
                                    ...
                                    <ItemStyle Wrap="False" />
                                    <FooterTemplate>
                                        <asp:TextBox ID="txtFoottotalAC0" runat="server" CssClass="form-control form-control-sm txtnew text-uppercase" ReadOnly="true" Width="95" Text='' placeholder="0"></asp:TextBox>
                                    </FooterTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Total Difference between A/C 1">
                                    ...
                                    <ItemStyle Wrap="False" />
                                    <FooterTemplate>
                                        <asp:TextBox ID="txtFoottotalAC1" runat="server" CssClass="form-control form-control-sm txtnew text-uppercase" ReadOnly="true" Width="95" Text='' placeholder="0"></asp:TextBox>
                                    </FooterTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Total EPF(Administration Charges) A/C 2">
                                    ...
                                    <ItemStyle Wrap="False" />
                                    <FooterTemplate>
                                        <asp:TextBox ID="txtFoottotalAC2" runat="server" CssClass="form-control form-control-sm txtnew text-uppercase" ReadOnly="true" Width="95" Text='' placeholder="0"></asp:TextBox>
                                    </FooterTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Employer Contribution A/C 10">
                                    ...
                                    <ItemStyle Wrap="False" />
                                    <FooterTemplate>
                                        <asp:TextBox ID="txtFoottotalAC10" runat="server" CssClass="form-control form-control-sm txtnew text-uppercase" ReadOnly="true" Width="95" Text='' placeholder="0"></asp:TextBox>
                                    </FooterTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Total EDLI Contribution(ER Share) A/C 21">
                                    ...
                                    <ItemStyle Wrap="False" />
                                    <FooterTemplate>
                                        <asp:TextBox ID="txtFoottotalAC21" runat="server" CssClass="form-control form-control-sm txtnew text-uppercase" ReadOnly="true" Width="95" Text='' placeholder="0"></asp:TextBox>
                                    </FooterTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Total EDLI (Administration Charges) A/C 22">
                                    ...
                                    <ItemStyle Wrap="False" />
                                    <FooterTemplate>
                                        <asp:TextBox ID="txtFoottotalAC22" runat="server" CssClass="form-control form-control-sm txtnew text-uppercase" ReadOnly="true" Width="95" Text='' placeholder="0"></asp:TextBox>
                                    </FooterTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Total Employer Share">
                                    ...
                                    <ItemStyle Wrap="False" />
                                    <FooterTemplate>
                                        <asp:TextBox ID="txtFoottotalShare" runat="server" CssClass="form-control form-control-sm txtnew text-uppercase" ReadOnly="true" Width="95" Text='' placeholder="0"></asp:TextBox>
                                    </FooterTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Total (EE + Employer) Contribution">
                                    ...
                                    <ItemStyle Wrap="False" />
                                    <FooterTemplate>
                                        <asp:TextBox ID="txtFoottotalContribution" runat="server" CssClass="form-control form-control-sm txtnew text-uppercase" ReadOnly="true" Width="95" Text='' placeholder="0"></asp:TextBox>
                                    </FooterTemplate>
                                </asp:TemplateField>

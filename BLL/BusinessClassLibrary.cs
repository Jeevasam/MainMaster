...
namespace BLL
{
    ...
    public class ClsBusnssLayer
    {
        ...
        {
            ObjectDA.CompanyMasterInsertandUpdate(TypeId, COMPANYCODE, COMPANYNAME, SECTOR, ADDRESS1, ADDRESS2, ADDRESS3, ADDRESS4, EMAIL, WEB, OFFICENO1, OFFICENO2,
                MOBILENO, FAXNO, GSTNO, CSTNO, ECCNO, CODENO, ESI, PF, PINCODE, DATE, CREATEBY, CREATEDATE);
        }
        ...
        {
           ObjectDA.ClientMasterInsertandUpdate(TypeId, CLIENTCODE, CLIENTNAME, DIVISION, CREATEBY, CREATEDATE);
        }
        ...
        //{
        //    ObjectDA.InsertStateData(StateName);
        //}
        ...
        {
            ObjectDA.CityMasterInsertAndUpdate(TypeId, StateID, CityName, CreateBy, CreateDate);
        }

        //public void InsertCity(string StateID, string CityName)
        //{
        //    ObjectDA.InsertCityData(StateID, CityName);
        //}
        ...
        {
            ObjectDA.LCMClientDetailInsertandUpdate(TypeId, CLIENTID, COMPANYID, DIVISION, SECTOR, ADDRESS1, TOWN, STATEID, CITYID, ENDATE, PANNO, GSTNO, REGNO, EPFNO, ESINO, PHONENO,
                MOBILENO, HRNO, ACCNO, EMAILID, WEBSITE, FROMDATE, TODATE, CREATEBY, CREATEDATE);
        }
      ...
      //  }
       ...
       string PemGST, string PemCST, string PemECC, string PemCode, string PemPFNo, string PemEsiNo, string PemOff1, string PemMob, string PemHrNo, string PemAccNo, string PemEmail, string PemWeb, string PemFromdt, string PemTodt, string CREATEBY, string CREATEDATE)
        {
            ObjectDA.PEMClientDetailInsertandUpdate( TypeId,  ClntID,  CmpID,  PemDiv,  PemSec,  PemStr,  PemTown,
             PemCity,  PemState,  PemEnDate,  PemPANNO,
        PemGST,  PemCST,  PemECC,  PemCode, PemPFNo,  PemEsiNo,  PemOff1, PemMob, PemHrNo,  PemAccNo,  PemEmail,  PemWeb,  PemFromdt,  PemTodt,  CREATEBY,  CREATEDATE);
        }
    ...
    public object SelectPEMClinet()
        ...
        {
            ObjectDA.CCClientDetailInsertandUpdate(TYPEID, ClntID, CmpID, LcmDiv, LcmSec, LcmStr, LcmTown, LcmCity, LcmState, LcmEnDate, LcmGST, LcmOff1, LcmMob, LcmHrNo, LcmAccNo, LcmEmail,
                LcmWeb, LcmEpfNo, LcmEsiNo, LcmRegNo, LcmFromdt, LcmTodt, CREATEBY, CREATEDATE);
        }
   ...
   //     }
        ...
        {
            ObjectDA.DepartmentMasterInsertAndUpdate(TYPEID, DepartmentName, ClientID, DepartmentCode, CreateBy, CreateDate);
        }
        ...
        {
           ObjectDA.DesignationMasterInsertAndUpdate(TypeId, DesignationCode, DesignationName, ClientID, CreateBy, CreateDate);
        }
        ...
        {
            ObjectDA.BankDetailInsertAndUpdate(TypeId, BankName, BankCode, Branch, Account, Address, Phoneno, EmialId, Others, CreateBy, CreateDate);
        }
        ...
        public void SalaryDetailInsertandUpdate (string TypeId, string ClntId, string Division, string Grade, string Basic, string Hra, string DA, string Convy, string Washing, string Others,
                                       string Total, string Otamt, string Special, string Bonus, string PF, string ESI, string Graduity, string Leavewage, string OtHour, string OtHour2, string Otamt2, string OtHour3, string Otamt3, string CreateBy, string CreateDate)
        {
             ObjectDA.SalaryDetailInsertandUpdate (TypeId, ClntId, Division, Grade, Basic, Hra, DA, Convy, Washing, Others, Total, Otamt, Special, Bonus, PF, ESI, Graduity, Leavewage, OtHour, OtHour2, Otamt2, OtHour3, Otamt3, CreateBy, CreateDate);
        }
    ...
    string Ot28, string Ot29, string Ot30, string Ot31, string FrmDt, string ToDt, string Flag, string TotPre, string TotOT)
        ...
        {
            return ObjectDA.SelectESIEstablishment(ClntId, EmpCode);
        }
        ...
        {
            ObjectDA.UserSettingInsert(USERNAME, PASSWORD);
        }
